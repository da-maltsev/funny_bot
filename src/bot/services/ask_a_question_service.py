...
class AskQuestionService(BaseBotService):
    let_me_think: list[str] = [
        ...
        "Дайте минутку...",
        "Отвечает Никита...",
        "Сейчас отвечу. Также рекомендую попробовать продолжить общение в веб-версии по адресу https://urf4cknmt.com . Там сохраняется контекст предыдущих сообщений и вообще там круто",
    ]
